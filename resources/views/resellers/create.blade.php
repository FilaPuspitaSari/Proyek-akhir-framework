...
<head>
    <title>Create Data Reseller</title>
...
<div class="col-sm-12 text-center">
    <h1 class="m-3">Tambah Data Reseller</h1>
</div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input class="form-control" type="text" name="umur" placeholder="Umur"></input>
    </div>
  </div>
